---
tags: [google-apps-script, consolidacion-datos, optimizacion-de-api, daily-report]
aliases: [Reportes Diarios, Daily Report, DR, Reportes_Diarios_SOP, SOP Reportes Diarios, README]
---

# Reportes Diarios (Daily Report)

**Tecnologías:** [[Google Apps Script]]
**Procesos:** [[Consolidación de Datos]], [[Optimización de API]]

- **Estructura de la carpeta:** `gas/` (orquestación `03 Ejecutar_DR.js`, extracción de recursos/actividades estándar y BESS, consolidados, `appsscript.json`, `.clasp.json`).
