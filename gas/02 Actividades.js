 ...
 *  - Inserción en UN solo setValues con todas las filas nuevas (reduce recalculo).
 *  - Pausa condicional tras borrar (solo si hubo filas, 2 s) para permitir que cesen recalculos del consolidado.
